    ...
    <div className="min-h-screen flex items-center justify-center bg-aura-gradient p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[500px] relative z-10 animate-fade-in">
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-2xl font-bold tracking-tight text-on-surface mb-2">Create Account</h1>
          <p className="text-slate-500">Join the IntoreAI Network</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <label className="block">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1 mb-1.5 block">Username</span>
                <input
                  required
                  minLength={3}
                  maxLength={20}
                  ...
                  className="w-full bg-white/50 border border-white/60 rounded-2xl px-4 py-3 focus:ring-4 ring-sky-500/10 outline-none transition-all placeholder:text-slate-300 font-medium"
                />
              </label>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <label className="block">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1 mb-1.5 block">First Name</span>
                <input 
                  required
                  value={firstName}
                  onChange={(e) => setFirstName(e.target.value)}
                  className="w-full bg-white/50 border border-white/60 rounded-2xl px-4 py-3 focus:ring-4 ring-sky-500/10 outline-none transition-all font-medium"
                />
              </label>
              <label className="block">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1 mb-1.5 block">Last Name</span>
                <input 
                  required
                  value={lastName}
            ...
            <div className="space-y-4">
              <label className="block">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1 mb-1.5 block">Identity Email</span>
                <input 
                  type="email"
                  required
                  value={email}
